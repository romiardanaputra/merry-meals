...
<main class="bg-[#FFFCF0] font-poppins">
    ...
    <div class="flex justify-center m-auto my-[70px] text-justify leading-relaxed space-x-[50px]">
        <div class="overflow-y-auto w-[563px] h-[316px]">
            ...
            <p class="text-[20px] text-[#282222] mt-[20px]">
                {{ $meal->mealIngredient }}
            </p>
            <p class="text-[20px] text-[#282222] mt-[20px]">
        ...
        <div class="flex flex-col space-y-[50px]">
            ...
            <div class="flex flex-row justify-between">
                <a href="{!! route('meal.menu') !!}">
                    <button
                        class="bg-[#FFFCF0] border-2 border-[#A07C00] text-[16px] text-[#A07C00] h-[64px] w-[271px] hover:scale-105 duration-500">
                        BACK
                    </button>
                </a>
                <a href="{!! route('meal.package',$meal->id) !!}">
                    <button
                        class="bg-[#A07C00] border-2 border-[#A07C00] text-[16px] text-[#FFFCF0] h-[64px] w-[271px] hover:scale-105 duration-500">
                        SELECT
                    </button>
                </a>
            </div>
