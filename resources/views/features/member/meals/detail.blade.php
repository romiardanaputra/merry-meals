    ...
    <div class="max-w-[1400px] mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <div class="lg:col-span-7 relative">
                <div class="aspect-[16/10] rounded-[3rem] overflow-hidden shadow-2xl shadow-dark/10 group">
            ...
            <div class="lg:col-span-5 space-y-10">
                <div class="space-y-4">
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        <span class="px-4 py-1.5 bg-dark text-white rounded-full text-[9px] font-black uppercase tracking-widest italic">{{ $meal->mealType }}</span>
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="w-2 h-2 rounded-full {{ $meal->mealAvailability == 'available' ? 'bg-green-500' : 'bg-red-500' }}"></div>
                            <span class="text-[10px] font-black uppercase tracking-widest {{ $meal->mealAvailability == 'available' ? 'text-green-600' : 'text-red-500' }}">{{ $meal->mealAvailability }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="bg-white rounded-2xl p-5 border border-black/5 text-center">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <p class="text-sm text-dark/60 font-medium leading-relaxed">{{ $meal->mealDescription }}</p>
                    </div>
                </div>

                @if($meal->mealAvailability == 'available')
                <div class="pt-10 border-t border-black/5 flex flex-col gap-4">
                    ...
                    <p class="text-center text-[10px] text-dark/40 font-medium">Choose your preferred delivery schedule</p>
                </div>
                @else
                <div class="pt-10 border-t border-black/5">
                    <div class="bg-red-50 rounded-2xl p-6 text-center">
                        <p class="text-sm font-bold text-red-500">This meal is currently unavailable</p>
                        <p class="text-xs text-red-400 mt-1">Please check back later or choose another meal</p>
                    </div>
                </div>
                @endif
            </div>
