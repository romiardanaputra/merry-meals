...
<header x-data="{ mobileMenuOpen: false }" class="max-w-[1800px] mx-auto flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-12 px-2">
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="flex flex-col w-full">
            ...
            <nav class="flex-1 space-y-2">
                ...
                <a href="{{ route('meal.menu') }}" class="flex items-center px-6 py-3.5 rounded-xl transition-all duration-300 {{ Request::routeIs('meal.menu') ? 'bg-primary text-dark font-black shadow-lg shadow-primary/20' : 'text-white/60 hover:text-white hover:bg-white/5 font-bold' }}">
    ...
    <nav x-data="{ 
            activeIndex: {{ 
                ['member.dashboard' => 0, 'meal.menu' => 1, 'member.survey' => 2, 'profile.edit' => 3][Route::currentRouteName()] ?? 0 
            }},
            get sliderStyle() {
