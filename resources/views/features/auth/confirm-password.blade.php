        ...
        <div class="w-full max-w-md space-y-12">
            ...
            <div class="text-center space-y-4 animate-on-scroll">
                <div class="flex flex-col items-center gap-4">
                    ...
                    <span class="text-xs font-black uppercase tracking-[0.4em] text-dark/40">Secure Access</span>
                </div>
                <div class="space-y-2">
                    <h2 class="text-h2 text-dark tracking-tighter">Confirm Access</h2>
                    <p class="text-dark/40 font-medium italic px-4">This is a secure area. Please confirm your password before continuing.</p>
                </div>
            </div>
            ...
            <p class="text-center text-dark/40 font-medium">
                ...
                <form method="POST" action="{{ route('logout') }}" class="inline">
                    @csrf
                    <button type="submit" class="text-primary font-black hover:underline cursor-pointer">Logout</button>
                </form>
            </p>
        </div>
    </div>
