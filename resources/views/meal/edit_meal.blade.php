    ...
    <div class="bg-register h-fit w-full bg-[#FFFCF0] py-[138px] px-[147px]">
        <div style="box-shadow: 0px 8px 50px rgba(174, 168, 135, 0.5);"
            ...
            <div class="form-register-fields w-full">
                <form action="{{ route('meal.update', $meal->id) }}" class="flex flex-col space-y-[24px]" method="POST" enctype="multipart/form-data" >
                    @csrf
                    @method('PUT')
                    <div class="flex flex-row space-x-[45px]">
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="text"
                                ...
                                name="name" required value="{{ old('name ') ?? $meal->name }}">
                        ...
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="file"
                                ...
                                name="path" required value="{{ old('path') }}">
