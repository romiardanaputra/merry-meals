                ...
                <form action="/register" method="POST" class="shadow-lg w-1/2 rounded-lg m-auto">
                    ...
                    <div class="form-detail px-[10rem] py-[5rem] flex justify-center items-center flex-col">
                        <div class="mb-6 w-full block  ">
                            <input class="input input-bordered input-secondary w-full block px-6 py-6 @error('first_name') @enderror"
                        ...
                        <div class="mb-6 w-full block">
                            <input class="input input-bordered input-secondary w-full block px-6 py-6 @error('last_name') @enderror"
                        ...
                        <div class="mb-6 w-full block  ">
                            <input class="input input-bordered input-secondary w-full block px-6 py-6 @error('username') @enderror"
