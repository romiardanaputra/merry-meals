                ...
                <form action="{{ route('registration.store') }}" class="flex flex-col space-y-[24px]">
                    ...
                    <div class="flex flex-row space-x-[45px]">
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="text" class="bg-[#FFFCF0] border border-gray-400 w-full py-2 px-3 @error('full_name')@enderror" name="full_name">
                        ...
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="text" class="bg-[#FFFCF0] border border-gray-400 w-full py-2 px-3 @error('usernmae')@enderror" name="username">
                    ...
                    <div class="flex flex-row space-x-[45px]">
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="email" class="bg-[#FFFCF0] border border-gray-400 w-full py-2 px-3 @error('email')@enderror" name="email">
                        ...
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="text" class="bg-[#FFFCF0] border border-gray-400 w-full py-2 px-3 @error('phone_number')@enderror" name="phone_number">
                    ...
                    <div class="flex flex-row space-x-[45px]">
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="number" class="bg-[#FFFCF0] border border-gray-400 w-full py-2 px-3 @error('age')@enderror" name="age">
                        ...
                        <div class="text-gray-500 w-1/2">
                            ...
                            <select class="w-full bg-[#FFFCF0] border border-gray-400 text-gray-500 py-2 px-3 pr-8 leading-tight focus:outline-none focus:bg-[#FFFCF0] focus:border-gray-500 @error('role')@enderror" id="role" name="role">
                    ...
                    <div class="flex flex-row space-x-[45px]">
                        <div class="text-gray-500 w-full">
                            ...
                            <input type="text" class="bg-[#FFFCF0] border border-gray-400 w-full py-2 px-3 @error('address')@enderror" name="address">
                    ...
                    <div class="flex flex-row space-x-[45px]">
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="password" class="bg-[#FFFCF0] border border-gray-400 w-full py-2 px-3 @error('password')@enderror" name="password">
                        ...
                        <div class="text-gray-500 w-1/2">
                            ...
                            <input type="password" class="bg-[#FFFCF0] border border-gray-400 w-full py-2 px-3 @error('confirm_password')@enderror" name='confirm_password'>
