...
<div class="container-packaging px-[147px] py-[92px] min-h-screen max-h-fit w-full">
    ...
    <div class="package-list flex flex-row justify-center space-x-[20px] w-full">
        <div class="basic-package h-[624px] w-full bg-[#FFFDF6] shadow-[0px_8px_50px_rgba(174,168,135,0.5)]">
            ...
            <div class="basic-package-content px-[150px] h-full flex flex-col items-center justify-between pb-[47px]">
                ...
                <div class="separation">
                    ...
                    <div class="basic-package-content-text text-[#282222] flex flex-col items-center space-y-[19px]">
        ...
        <div class="exclusive-package h-[624px] w-full bg-[#FFFDF6] shadow-[0px_8px_50px_rgba(174,168,135,0.5)]">
            ...
            <div class="exclusive-package-content px-[150px] h-full flex flex-col items-center justify-between pb-[47px]">

                <div class="separation">
                    <div class="exclusive-package-content-image h-[262px] w-[262px]">
                        <img src="/images/FoodPackageExclusive.png" class="h-[262px] w-[262px]" alt="exclusivePackage">
                    </div> <!-- exclusive-package-content-image -->

                    <div class="exclusive-package-content-text text-[#282222] flex flex-col items-center space-y-[19px]">
