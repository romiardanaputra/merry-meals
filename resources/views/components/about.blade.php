...
<main class="bg-[#FFFCF0]">
    ...
    <div class="bg-[#FFE383] font-Poppins text-[#282222] h-[490px] flex justify-between pl-[147px] leading-relaxed">
        <div class="w-[504px] h-[150px] mt-[100px]">
            ...
            <p class="font-Poppins text-[20px] text-[#282222] text-justify">The most vulnerable elderly and individuals
                with disabilities in Indonesia are presently confronting extreme food insecurity. Merry Meal continues
                to expand to satisfy the rising need for healthy and inexpensive meals.</p>
        </div>
    ...
    <!-- content2 -->
    <div
        class="bg-[#FFFCF0] w-full h-fit flex flex-col justify-center font-Poppins text-[#282222] px-[147px] pt-[163px] leading-relaxed">
        ...
        <div class="constribution text-[#282222] text-center flex flex-col space-y-[84px] w-full">
            ...
            <div class="constribution-icons w-full h-fit flex flex-row justify-between">
                <div class="bg-i-fork flex flex-col items-center justify-center">
                    <div
                        class="i-fork h-[177px] w-[177px] bg-gradient-to-t from-[#FFA800] to-[#FFCE01] rounded-[50%] flex items-center justify-center text-[#FFFCF0] text-[75px]">
                ...
                <div class="bg-i-user flex flex-col items-center justify-center">
                    <div
                        class="i-user h-[177px] w-[177px] bg-gradient-to-t from-[#FFA800] to-[#FFCE01] rounded-[50%] flex items-center justify-center text-[#FFFCF0] text-[75px]">
                ...
                <div class="bg-i-handlove flex flex-col items-center justify-center">
                    <div
                        class="i-handlove h-[177px] w-[177px] bg-gradient-to-t from-[#FFA800] to-[#FFCE01] rounded-[50%] flex items-center justify-center text-[#FFFCF0] text-[75px]">
                ...
                <div class="bg-i-person flex flex-col items-center justify-center">
                    <div
                        class="i-person h-[177px] w-[177px] bg-gradient-to-t from-[#FFA800] to-[#FFCE01] rounded-[50%] flex items-center justify-center text-[#FFFCF0] text-[75px]">
