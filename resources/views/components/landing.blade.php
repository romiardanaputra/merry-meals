...
<body class="font-poppins">
    ...
    <div style="background-image: url('images/landingSalad.png')" class="bg-hero-banner h-[813px] bg-no-repeat bg-center bg-cover py-[151px] leading-relaxed">
    ...
    <div class="section-serve h-[874px] bg-[#FFFCF0] py-[222px] pl-[147px] flex items-center leading-relaxed">
        <div class="section-serve-content h-[431px] w-full flex flex-row justify-between space-x-[86px]">
            <div class="section-serve-content-text w-[430px] text-[#282222] flex flex-col space-y-[64px]">
                ...
                <a href="{{ route('about') }}"><button class="bg-[#FFFCF0] border-2 border-[#A07C00] text-[16px] text-[#A07C00] h-[63px] w-[370px] hover:scale-105 duration-500">Learn more about Merry Meals</button></a>
    ...
    <div style="background-image: url('images/landingPageImage3Edited.jpg');" class="section-healthy h-[662px] w-full bg-no-repeat bg-cover bg-left py-[86px] flex justify-end leading-relaxed">
    ...
    <div class="section-charity bg-[#FFFDF6] h-[1037px] w-full py-[222px] px-[147px] flex justify-center items-center leading-relaxed">
        <div class="section-charity-content h-[593px] w-[1144px] flex flex-col justify-center items-center space-y-[71px] text-[#282222] text-center">
            ...
            <a href="{{ route('donation') }}" class="font-semibold"><button class="h-[271px] w-[271px] text-[40px] text-[#FFFDF6] py-[75px] px-[61px] bg-gradient-to-t from-[#FFA800] to-[#FFCE01] hover:scale-105 duration-500 text-justify z-1">Donate Now <i class="fa fa-solid fa-right-long"></i></button></a>
