...
<main class="font-poppins">
    <div class="form-register-fields w-full pr-[5rem] mx-[10px]">
        <form action="{{ route('partner_handler.update', $partners)}}" class="flex flex-col space-y-[24px]"
            ...
            <div class="flex flex-row space-x-[45px]">
                ...
                <div class="text-gray-500 w-1/2">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('restaurant_name')  ?? $partners->restaurant_name }}">
            ...
            <div class="flex flex-row space-x-[45px]">
                <div class="text-gray-500 w-1/2">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('restaurant_contact')  ?? $partners->restaurant_contact }}">
                ...
                <div class="text-gray-500 w-1/2">
                    ...
                    <input type="file"
                        class="bg-[#FFFCF0] border border-gray-400 w-full file-input file-input-bordered @error('restaurant_image')@enderror"
            ...
            <div class="flex flex-row space-x-[45px]">
                <div class="text-gray-500 w-1/2">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('restaurant_address') ?? $partners->restaurant_address }}">
                ...
                <div class="text-gray-500 w-1/2">
                    ...
                    <select
                        ...
                        id="food_type" name="food_type" required value="{{ old('food_type') ?? $partners->food_type }}">
            ...
            <div class="flex justify-end">
                ...
                <button type="submit"
                    class="mt-[30px] h-[35px] w-[180px] border-2 border-[#A07C00] bg-[#FFFCF0] font-medium text-[16px] text-[#A07C00] hover:scale-105 duration-500">Update
                    Partner</button>
            </div> <!-- button-flex -->
        </form>
