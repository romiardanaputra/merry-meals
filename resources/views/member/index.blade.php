...
@include('components.navbar')
    <main class="bg-[#FFFCF0] w-full min-h-screen max-h-fit">
        ...
        <div class="bg-content px-[147px] py-[110px]">
            ...
            <div class="grid grid-cols-3 gap-[50px] flex-row">
                ...
                <div class="card-meal w-full bg-[#FFFCF0] h-[500px] flex flex-col shadow-xl rounded-xl">
                    ...
                    <div class="desc flex flex-col justify-evenly">
                        ...
                        <div class="button-order p-[44px]">
                            <a href=""><button class="w-full bg-[#EDB01C] text-[#FFFCF0] p-[10px] rounded-xl hover:scale-105 duration-700">Order Now</button></a>
                            <a href="{{ route('meal_menu', $meal->id) }}"><button class="w-full bg-[#EDB01C] text-[#FFFCF0] p-[10px] rounded-xl hover:scale-105 duration-700">Preview</button></a>
                        </div> <!-- button-order -->
                    </div> <!-- desc -->
                </div> <!-- card-meal -->
